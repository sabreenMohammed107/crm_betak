                ...
                <div class="col-12">
                    <div class="ms-panel ms-panel-fh">
                        <div class="ms-panel-body">
                            ...
                            <form class="needs-validation" action="{{route('update-lead-activity')}}" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div class="  col-sm-6 col-md-5  d-flex">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <option value="" disabled> @if($activity->assign){{ $activity->assign->name }}@endif </option>
                                ...
                                <div class="  col-sm-6 col-md-5  d-flex">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <option value="" disabled> @if($activity->solved){{$activity->solved->name }}@endif </option>
