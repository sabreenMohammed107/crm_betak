...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('todoList.index') }}">ToDo </a></li>
  </ol>
</nav>
      ...
      <div class="col-md-12">
        <div class="ms-panel">
          <div class="ms-panel-header d-flex justify-content-between">
            <h6>ُActivities </h6>
            <a href="{{ route('add-todoList-activity',$row->id) }}" class="btn btn-dark"> add Activities </a>
              ...
              <table id="courseEval" class="dattable table table-striped thead-dark  w-100">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('edit-todoList-activity',$activity->id) }}" class="btn btn-dark d-inline-block">Edit</a>
                      <a href="#" onclick="destroy('this row','{{$activity->id}}')" class="btn d-inline-block btn-danger">delete</a>
                      <form id="delete_{{$activity->id}}" action="{{ route('delete-todoList-activity', $activity->id) }}" method="POST" style="display: none;">
                        @csrf
                        @method('DELETE')
                        <button type="submit" value=""></button>
                      </form>
